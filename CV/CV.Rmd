...
## In Preparation
1.	**Van Pelt KL**, Lin A, Koehl L, Caban-Holt A, Anderson-Mooney A, Powell D, Head E, Schmitt F. (In Preparation). Longitudinal Assessment of 1H-MRS Metabolites in Adults with Down Syndrome: age and dementia effects. 
...
8.	Memmini AK, **Van Pelt KL**, Wicklund AH, Breedlove KM, Broglio SP. (Under Review). Influence of adult and child-specific modifiers on youth contact sports participation. J Athl Train


## Refereed Journal Publications
Complete List of Published Work in My Bibliography: https://www.ncbi.nlm.nih.gov/myncbi/browse/collection/46831018/

1.	**Van Pelt KL**, Caccese JB, Eckner JT, Putukian M, Brooks MA, Cameron KL, Houston MN, Jackson JC, McGinty GT, Hillis CJ, McAllister T, McCrea MA, Broglio SP, Buckley TA. (In Press, 2021). Detailed Description of Division I Ice Hockey Concussions: Findings form the NCAA and Department of Defense CARE Consortium. Journal of Sport and Health Science. doi: 10.1016/j.jshs.2021.01.004

1.	**Van Pelt KL**, Puetz T, Swallow J, Lapointe AP, Broglio SP. (In Press, 2021). A Systematic-Review and Meta-Analysis of Concussion Rates: A Data-Driven Concussion Risk Classification. Sports Medicine. doi: 10.1007/s40279-021-01428-7
