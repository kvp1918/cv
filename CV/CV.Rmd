...
1.	DiProspero DN, Keator DB, Phelan M, van Erp TGM, Doran E, Powell DK, **Van Pelt KL**, Schmitt F, Head E, Lott IT, Yassa MA. (Accepted, 2021). Selective impairment of long-range default mode network functional connectivity as a biomarker for preclinical Alzheimer’s disease in older individuals with Down syndrome. Journal of Alzheimer’s Disease.
