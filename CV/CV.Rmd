...
## In Preparation
1.	**Van Pelt KL**, Lin A, Koehl L, Caban-Holt A, Anderson-Mooney A, Powell D, Head E, Schmitt F. (Under Review). Longitudinal Assessment of 1H-MRS Metabolites in Adults with Down Syndrome: age and dementia effects. Neurobiology of Aging.

1.	**Van Pelt KL**, Wolff L, Campbell DE, McGinty G, Zupan M, Jackson JC. (Under Review). A preliminary exploration of the impact of aerobic and muscular fitness on mild traumatic brain injury among service academy members at the United States Air Force Academy. Military Medicine.

1.	Memmini AK, **Van Pelt KL**, Wicklund AH, Breedlove KM, Broglio SP. (Under Review). Influence of adult and child-specific modifiers on youth contact sports participation. J Athl Train

1.	**Van Pelt KL**, Ross B, Dowling M, Pradhan AK, Broglio SP. (In Preparation). Subtle persistent effects of concussion on driving. 

1.	**Van Pelt KL**, McCarty K, Davis R, Lykins J, Jicha G, Caban-Holt A, Lightner D, Robertson W, Brothers S, Thalman SW, Lin A, Powell D, Head E, Schmitt F. (In Preparation). Regional and Longitudinal Changes in Cerebral Blood Flow in Individuals with Down Syndrome.

1.	DiProspero DN, Keator DB, Phelan M, van Erp TGM, Doran E, Powell DK, **Van Pelt KL**, Schmitt F, Head E, Lott IT, Yassa MA. (In Preparation). Selective impairment of long-range default mode network functional connectivity as a biomarker for preclinical Alzheimer’s disease in older individuals with Down syndrome.


## Refereed Journal Publications
Complete List of Published Work in My Bibliography: https://www.ncbi.nlm.nih.gov/myncbi/browse/collection/46831018/

1. Carmona-Iragui M, Alcolea D, Barroeta I, Videla L, **Van Pelt KL**, Schmitt F, Lightner D, Koehl L, Sacco S, Mircher C, Pape S, Nübling G, Levin J, Zaman S, Strydom A, Rebillat A, Head E, Blesa R, Lleó A, Fortea J. (Accepted, 2021). Prognostic performance and longitudinal changes in plasma Neurofilament light levels in Down syndrome: a multicenter longitudinal study. Lancet Neurology.
